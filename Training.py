...
testRatio = 0.3  # if 1000 images split will 200 for testing
...
def myModel():
    ...
    size_of_Filter2 = (3, 3)
    size_of_pool = (2, 2)  # SCALE DOWN ALL FEATURE MAP TO KERNALIZE MORE, TO REDUCE OVERFITTING
    no_Of_Nodes = 250  # NO. OF NODES IN HIDDEN LAYERS
    model = Sequential()
    ...
    model.add((Conv2D(no_Of_Filters, size_of_Filter, activation='relu', kernel_initializer='he_uniform')))
    ...
    model.add(Flatten())
    model.add(Dense(no_Of_Nodes, activation='relu', kernel_initializer='he_uniform'))
    model.add(Dropout(0.5))  # INPUTS NODES TO DROP WITH EACH UPDATE 1 ALL 0 NONE
    model.add(Dense(noOfClasses, activation='sigmoid'))  # OUTPUT LAYER  ,
    # Binary Classification use sigmoid, Multi-Classification use softmax

    # COMPILE MODEL #categorical_crossentropy and binary crossentropy
